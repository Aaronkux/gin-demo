...
type SysClient struct {
	...
	Referrals      []SysReferral       `json:"referrals" gorm:"many2many:sys_client_referral;"`
	// documents related
	...
	Document1Expiry  time.Time           `json:"document1Expiry" gorm:"comment:证件1有效期"`
	...
	Document2Expiry  time.Time           `json:"document2Expiry" gorm:"comment:证件2有效期"`
	...
	// **individual part**
	// client
	Gender         int             `json:"gender" gorm:"type:tinyint(1);comment:性别"`
	...
	AccountHolderDOB      *time.Time `json:"accountHolderDOB" gorm:"comment:主要账户生日"`
